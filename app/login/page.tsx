      ...
      <section className="login-shell" aria-label="Login MOVENT">
        <div className="login-panel login-panel-form">
          <div className="login-form-inner">
            <div className="login-brand-wrap">
              <img src="/assets/branding/movent-dark.svg" alt="MOVENT" className="login-brand-image" />
            </div>
        ...
        <aside className="login-panel login-panel-visual" aria-hidden="true">
          ...
          <div className="login-visual-copy">
            ...
            <h2>Setiap pergerakan.<br />Satu kendali<span className="login-dot">.</span></h2>
            <p>
          ...
          <div className="login-visual-board">
            <div className="login-board-toolbar">
              <div className="login-board-dots"><span /><span /><span /></div>
            ...
            <div className="login-board-body">
              ...
              <div className="login-board-content">
                <div className="login-board-heading"><span /><span /></div>
                <div className="login-board-cards">
                  <div><small>Tugas</small><strong>Operasional</strong><i /></div>
                  <div><small>Jadwal</small><strong>Timetable</strong><i /></div>
                  <div><small>Ticketing</small><strong>Maintenance</strong><i /></div>
                </div>
          ...
          <div className="login-float-card login-float-card-one">
            ...
            <div><small>Status</small><strong>Operasional terpantau</strong></div>
          </div>

          <div className="login-float-card login-float-card-two">
            <span className="login-float-icon">↗</span>
            <div><small>Alur kerja</small><strong>Lebih terstruktur</strong></div>
          </div>
        </aside>
      </section>
    </main>
