    ...
    <div className="role-page alert-page">
      <div className="super-dashboard-heading alert-page-heading">
        ...
        <nav className="alert-view-tabs" aria-label="Alert">
          <Link href="/controller/alert" className={view === 'penugasan' ? 'active' : ''}>Penugasan</Link>
          <Link href="/controller/alert?view=maintenance" className={view === 'maintenance' ? 'active' : ''}>Maintenance</Link>
        </nav>
      </div>
