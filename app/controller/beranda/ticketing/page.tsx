    ...
    <div className="role-page dashboard-page dashboard-ticketing-page">
      <div className="page-heading">
        <div>
          ...
          <h1>Maintenance</h1>
          <p>Pantau proses maintenance dari dibuat sampai selesai.</p>
        </div>
      </div>
      ...
      <section className="section-block dashboard-table-section">
        <div className="section-heading">
          <div><h2>Maintenance Terbaru</h2><p>Maintenance terbaru yang masuk dan sedang diproses.</p></div>
          ...
          <div className="table-wrap">
            <table>
              ...
              <tbody>
                ...
                {!tickets.length ? (
                  <tr><td colSpan={6}><div className="dashboard-empty-state"><strong>Belum ada maintenance.</strong><span>Kalau ada maintenance baru, nanti muncul di sini.</span></div></td></tr>
                ) : null}
              </tbody>
            </table>
          </div>
